...
crates/domain-electrical validation/rules. Changes outside these areas require Architect approval before implementation.
...
Do not modify frozen specification authority or introduce: new standards sources not defined, UI authority, AI. Do not edit another Work Order to make this implementation pass.
