...
## Acceptance criteria
- WO-007-AC01 — Each command has deterministic unit/property tests.
- WO-007-AC02 — Each command produces correct affected-ID sets.
- WO-007-AC03 — Undo/redo restores equivalent canonical state.
- WO-007-AC04 — Degenerate/invalid operations are rejected explicitly.
- WO-007-AC05 — Representative visual fixtures pass.
...
crates/core-commands and tests. Changes outside these areas require Architect approval before implementation.
...
Do not modify frozen specification authority or introduce: new commands not listed in spec/commands.md, UI, interop, electrical. Do not edit another Work Order to make this implementation pass.
