# WORK-017 — Components, Representations and Terminals

Status: BLOCKED-BY-W016,W008
Architecture: v1.1 frozen
Dependencies: WORK-016, WORK-008
Checkpoint: CP5

## Objective
Implement logical electrical components, multi-view representations and terminals.

## Acceptance criteria
- WO-017-AC01 — One logical component may have schematic/one-line/panel/report representations.
- WO-017-AC02 — Terminal ownership and stable numbering are enforced.
- WO-017-AC03 — Representation-to-entity links are traceable.
...
crates/domain-electrical component/terminal code plus document references. Changes outside these areas require Architect approval before implementation.
...
Do not modify frozen specification authority or introduce: wires/networks, catalog, AI, generic geometry. Do not edit another Work Order to make this implementation pass.
